...
* **Produto**
  - Attributes: Código, Nome, Preço, Taxa de IVA

* **Encomenda**
  - Attributes: Número de encomenda, Data

* **Fornecedor**
  - Attributes: Nome, Número de informação fiscal, Endereço, Número de fax, Condições de pagamento, Código interno do tipo de fornecedor

#### Relationships:

1. **Produto - Encomenda**
   - Relation: Um produto pode estar presente em várias encomendas, e uma encomenda pode conter vários produtos.
   - Cardinality: Muitos para muitos (M:N).
   - Attributes: Respetivas unidades

2. **Encomenda - Fornecedor**
   - Relation: Uma encomenda é feita para um único fornecedor, mas um fornecedor pode ter várias encomendas.
   - Cardinality: Um para muitos (1:N).
   - Attributes: N/A
...
1.**Produto - Encomenda** 
	- Grau: Binário 
	- Cardinalidade: 
		- Produto para Encomenda: Muitos para Muitos (N:1) 
		- Encomenda para Produto: Muitos para Muitos (1:N) 
	- Obrigatoriedade de Participação: 
		- Produto: Opcional 
		- Encomenda: Obrigatória 

1. **Encomenda - Fornecedor** 
	- Grau: Binário 
	- Cardinalidade: 
		- Encomenda para Fornecedor: Um para Muitos (N:1) 
		- Fornecedor para Encomenda: Muitos para Um (1:N) 
	- Obrigatoriedade de Participação: 
		- Encomenda: Obrigatória 
		- Fornecedor: Opcional
```
...
![ex_2_4b!](ex_2_4b.pdf "AnImage or PDF file")
