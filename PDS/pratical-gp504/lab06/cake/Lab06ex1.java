...
public class Lab06ex1 {
    public static void main(String[] args) {
        ...
        cakeMaster.createCake(Shape.Circle, 4, "The best"); // 4 cake layers
        cake = cakeMaster.getCake();
        System.out.println("Your cake is ready: " + cake);

        CakeBuilder RedVelvet = new RedVelvetCakeBuilder();
        cakeMaster.setCakeBuilder(RedVelvet);
        cakeMaster.createCake(Shape.Rectangle, 5, "Magnifique!"); // 5 cake layers
        cake = cakeMaster.getCake();
        System.out.println("Your cake is ready: " + cake);
    
        CakeBuilder Lo = new LoCakeBuilder();
        cakeMaster.setCakeBuilder(Lo);
        cakeMaster.createCake(Shape.Circle, 6, "The best"); // 6 cake layers
        cake = cakeMaster.getCake();
        System.out.println("Your cake is ready: " + cake);
    }
}
